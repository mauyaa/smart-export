...
# Ensure the api/ directory itself is importable when this module is loaded as
# part of the `api` package (e.g. `from api import main` under pytest). Without
# this, the absolute `from masumi import ...` below resolves against the repo
# root and fails. Mirrors the sys.path insert used for the ussd_handler import.
import sys
